"""
mlp_simple.py: Runs Multilayer Perceptron Neural Network to predict a user selected personality trait.

The data essays are converted to lowercase before use

Example usage:  1) python mlp_simple.py <trait>
                OR
                2) python mlp_simple.py <trait>  <activation>   <learning rate>  <solver>
                ...
                <learning rate> is one of ['constant', 'invscaling', 'adaptive']

                <solver> is one of ['lbfgs', 'sgd', 'adam']
